"""
Django settings for PlatePals project.
...
SECRET_KEY = 'django-insecure-#aza2nx8dcpgw@i*hxzhwcoscxjb!h(&npif44v^a(l86!iv^2'
...
DATABASES = {
     'default': {
        ...
        'CLIENT': {
            'host': 'mongodb+srv://testshadow:isrplatepals@platepals.exra1bp.mongodb.net/?retryWrites=true&w=majority&appName=platepals',
            'username': 'testshadow',
            'password': 'isrplatepals',
